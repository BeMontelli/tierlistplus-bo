<div class="row mb-4 ease-in duration-100 rounded-[10px] hover:p-2 hover:pl-4 hover:bg-gray-100 dark:hover:bg-gray-600">
    <div class="flex">
        ...
        <div class="name flex items-center w-5 text-left flex-auto font-medium text-gray-900 dark:text-white">
            <a class="hover:text-orange-400 transition ease-in" href="{{ route('categories.show', $category->id) }}">{{$category->title}}</a>
        </div>
