                ...
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form method="post" action="{{ route('tierlists.update', $tierlist) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{$tierlist->title}}" class="block form-control" type="text" name="title">
                            <label class="block mt-6 text-gray-500 dark:text-gray-400 leading-relaxed mb-2" for="description">Description</label>
                            <textarea class="block form-control" name="description" id="description" cols="30" rows="10">{{$tierlist->description}}</textarea>
                        </div>
